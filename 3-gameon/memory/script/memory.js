...
var MemoryApp = function (memoryGameName) {
    ...
    var standardPicture = "<img src='img/0.png' alt='Standard Bild' />";
    ...
    function getAPicture(counter, theLink) {
        if (turnedBricks.length === 2) {
            ...
            return "<img src='img/" + randomNumber + ".png' alt='Bild" + randomNumber + "' />";
        }
    }
    ...
    function generateCols() {
        ...
        theLink.onclick = function () {
            ...
            if (theLink.firstChild.alt === "Standard Bild"){
                ...
                rightOrWrong = turnedBrickControl(theLink);
                if (rightOrWrong) {
                    alert("Grattis du har nu " + ++rightGuesses + " Rätt.");
                    if (rightGuesses === 8) {
...
window.onload = function () {
    var memoryGame1 = new MemoryApp("Memorygame 1");
    var memoryGame2 = new MemoryApp("Memorygame 2");
}